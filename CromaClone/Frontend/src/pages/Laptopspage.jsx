...
const brands = ["All", "Apple", "Dell", "HP", "Lenovo", "ASUS", "Acer", "MSI"];
...
export default function LaptopsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] pt-10 pb-20">
      ...
      <HSlider title="Featured Laptops" subtitle="Top Picks" accent={accentColor} loading={loading} viewAllPath="/products/laptops/featured">
        {featuredProducts.map((p) => <FeaturedCard key={p._id} p={{ ...p, id: p._id }} />)}
      </HSlider>

      <HSlider title="Best Deals & Offers" subtitle="Limited Time" accent="#f97316" loading={loading} viewAllPath="/products/laptops/deals">
